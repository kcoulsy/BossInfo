...
class SulfuronHarbinger extends Component {
  render() {
    return (
      <MainContainer>
        <Head title="Home" />
        <BossList bosses={mc.bosses} selected="Sulfuron Harbinger" />
        <ContentContainer
          panels={[
            "Overview",
            "Abilities",
...
const Overview = () => (
  <div>
    <img
      ...
      alt="SulfuronHarbinger"
    />
    SulfuronHarbinger is one of the four flamewaker captains of Ragnaros, and the first
    boss of Molten Core.
  </div>
);
const Abilities = () => (
  <div>
    <h3>SulfuronHarbinger</h3>
    <p>
      <strong>
    ...
    <p>
      <strong>SulfuronHarbinger's Curse</strong>
...
const Strategy = () => (
  <div>
    <p>
      ...
      some room for the pullers and the main tank. It is important when SulfuronHarbinger
      is pulled that he not come near the main raid groupimport SulfuronHarbinger from './sulfuron-harbinger';
 or there could be an
    ...
    <p>
      ...
      SulfuronHarbinger in the opposite direction of his guards. Generally the back cove
      is where the guards are pulled, while SulfuronHarbinger is taken to another alcove
      on the east, far from the main raid. Each of the guards must then be
      picked up by two offtanks and dispatched accordingly before SulfuronHarbinger is
      targeted.
    </p>
    <br />
    <p>
      Mages will not be contributing any large part of the DPS in this fight as
      they will be tied up with removing the curse that SulfuronHarbinger casts on the
    ...
    <br />
    <p>
      Once the two guards are defeated, all DPS will shift over to SulfuronHarbinger.
    ...
    <br />
    <p>
      SulfuronHarbinger's debuffs have a range of 40 yards. It is possible for every
      healer (except the MT-decurser), and properly spec'ed hunters to stay out
      of SulfuronHarbinger's curse-range, so with a good group you can minimize every
    ...
    <br />
    <p>
      If SulfuronHarbinger is not defeated before the group wipes, the guards will
      respawn.{" "}
    </p>
  </div>
);
...
export default SulfuronHarbinger;
